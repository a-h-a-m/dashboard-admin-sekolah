          ...
          <div class="table-responsive22">
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>
                  <?php
                    $no = 1;
                    $queryview = mysqli_query($koneksi, "SELECT * FROM kelas");
                  ...
                  <tr>
                    ...
                    <td>
                      <!--<a href="../user/form_edituser.php?id=<?php echo $row['id_kelas']?>" class="btn btn-primary btn-flat btn-xs"><i class="fa fa-pencil"></i> Edit</a>-->
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <h4 align="center" >Apakah anda yakin ingin menghapus kelas <?php echo $row['kelas'];?><strong><span class="grt"></span></strong> ?</h4>
                              </div>
