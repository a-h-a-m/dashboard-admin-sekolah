          ...
          <div class="table-responsive22">
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>
                  <?php
                    $no = 1;
                    $queryview = mysqli_query($koneksi, "SELECT * FROM kontak");
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="http://wa.me/<?php echo $row['no_hp']; ?>" target="_blank" class="btn btn-success btn-flat btn-xs"><i class="fa fa-reply"></i> Chat</a>                      
